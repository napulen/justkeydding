...
$ g++ -D_VAMP_PLUGIN_IN_HOST_NAMESPACE -O2 -ffast-math chromaextract.cpp NNLSChroma.cpp NNLSBase.cpp chromamethods.cpp viterbi.cpp nnls.c -o chromaextract -lsndfile -lvamp-hostsdk -ldl
...
int main(int argc, char **argv)
{
  ...
  PluginInputDomainAdapter *ia = new PluginInputDomainAdapter(chroma);
...
// Plugin requires 1 channel (we will mix down)
  ...
  Plugin::FeatureList chromaFeatures;
